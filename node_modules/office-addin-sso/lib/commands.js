    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (Object.keys(userJson).length >= 1) {
            ...
            if (applicationJson) {
                ...
                defaults_1.usageDataObject.sendUsageDataException('createNewApplication', errorMessage);
            ...
            // Send usage data
            defaults_1.usageDataObject.sendUsageDataSuccessEvent('configureSSO', { configDuration: ssoConfigDuration });
        }
        else {
            const errorMessage = 'Login to Azure did not succeed';
            defaults_1.usageDataObject.sendUsageDataException('configureSSO', errorMessage);

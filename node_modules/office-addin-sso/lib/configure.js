        ...
        try {
            ...
            switch (process.platform) {
                case "win32":
                    ...
                    // Send usage data
                    defaults_1.usageDataObject.sendUsageDataSuccessEvent('isAzureCliInstalled', { cliInstalled: cliInstalled });
                    return cliInstalled;
                case "darwin":
...
function isUserTenantAdmin(userInfo) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.sendUsageDataSuccessEvent('isUserTenantAdmin', { isUserTenantAdmin: isTenantAdmin });
...
function setSharePointTenantReplyUrls(tenantName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.sendUsageDataSuccessEvent('setTenantReplyUrls', { isUserTenantAdmin: setReplyUrls });
            return setReplyUrls;
        }
        catch (err) {
...
function setOutlookTenantReplyUrl() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Send usage data
            defaults_1.usageDataObject.sendUsageDataSuccessEvent('setOutlookTenantReplyUrls', { tenantReplyUrlsSet: setReplyUrls });
            return setReplyUrls;
        }
        catch (err) {
            const errorMessage = `Unable to set tenant reply urls. \n${err}`;
            defaults_1.usageDataObject.sendUsageDataException('setOutlookTenantReplyUrls', errorMessage);
            throw new Error(errorMessage);
        }
    });
}

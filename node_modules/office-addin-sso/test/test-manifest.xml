...
<OfficeApp xmlns="http://schemas.microsoft.com/office/appforoffice/1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bt="http://schemas.microsoft.com/office/officeappbasictypes/1.0" xmlns:ov="http://schemas.microsoft.com/office/taskpaneappversionoverrides" xsi:type="TaskPaneApp">
  <Id>b4e0faf2-891f-4798-9f7f-43b1ddb6cdc6</Id>
  <Version>1.0.0.0</Version>
  <ProviderName>Contoso0</ProviderName>
  <DefaultLocale>en-US</DefaultLocale>
  <DisplayName DefaultValue="Office-Addin-Taskpane-SSO-Test"/>
  ...
  <HighResolutionIconUrl DefaultValue="https://localhost:{PORT}/assets/icon-80.png"/>
  ...
  <VersionOverrides xmlns="http://schemas.microsoft.com/office/taskpaneappversionoverrides" xsi:type="VersionOverridesV1_0">
    ...
    <Resources>
      ...
      <bt:ShortStrings>
        <bt:String id="GetStarted.Title" DefaultValue="Add Microsoft Graph data to your document!"/>
        <bt:String id="TaskpaneButton.Label" DefaultValue="Show Add-in"/>
        <bt:String id="CommandsGroup.Label" DefaultValue="SSO Node.js"/>
      </bt:ShortStrings>
      <bt:LongStrings>
        <bt:String id="GetStarted.Description" DefaultValue="Your sample add-in loaded succesfully. Go to the HOME tab and click the 'Show Taskpane' button to get started."/>
        <bt:String id="TaskpaneButton.Tooltip" DefaultValue="Click to show the SSO add-in."/>
      </bt:LongStrings>
    </Resources>
    <WebApplicationInfo>

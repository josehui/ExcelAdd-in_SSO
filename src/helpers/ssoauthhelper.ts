...
import { writeDataToOfficeDocument, writeDataToOfficeDocument2 } from "./../taskpane/taskpane";
let retryGetAccessToken = 0;

export async function addCellFunction(): Promise<void> {
  writeDataToOfficeDocument2();
  console.log("hihi");
}
